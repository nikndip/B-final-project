...
func seedExercises(db *sql.DB) error {
	exercises := []struct {
		...
		{"Планка", "Укрепляет мышцы кора и спины. Держите нейтральное положение и активируйте пресс.", "Кор", "Средняя", 3, "30-45 сек", 45, []string{"Пресс", "Спина"}, []string{"Коврик"}, ""},
		{"Супермен", "Лежа на животе, поднимайте руки и ноги. Подъем плавный, без рывков.", "Спина", "Легкая", 3, "12-15", 30, []string{"Спина"}, []string{"Коврик"}, ""},
		{"Ягодичный мост", "Поднимайте таз, удерживая пресс. Сведите лопатки и не переразгибайте поясницу.", "Ноги", "Легкая", 3, "12-15", 30, []string{"Ягодицы"}, []string{"Коврик"}, ""},
		{"Разведение рук с эспандером", "Контролируемое разведение рук. Лопатки сведены, движение плавное.", "Плечи", "Средняя", 3, "12-15", 30, []string{"Плечи"}, []string{"Эспандер"}, ""},
		{"Приседания к стулу", "Приседайте до касания стула. Колени смотрят по линии стоп.", "Ноги", "Легкая", 3, "10-12", 45, []string{"Ноги"}, []string{"Стул"}, ""},
		{"Растяжка груди", "Растяните грудные мышцы у стены. Дыхание спокойное, без боли.", "Растяжка", "Легкая", 2, "20-30 сек", 20, []string{"Грудь"}, []string{"Стена"}, ""},
		{"Кошка-корова", "Мобилизация позвоночника в спокойном темпе. Движение синхронизируйте с дыханием.", "Мобилизация", "Легкая", 2, "8-10", 20, []string{"Спина"}, []string{"Коврик"}, ""},
		{"Повороты корпуса сидя", "Мягкое вращение грудного отдела. Не скручивайте поясницу.", "Мобилизация", "Легкая", 2, "10-12", 20, []string{"Спина", "Кор"}, []string{"Стул"}, ""},
		{"Ходьба на месте", "Легкий разогрев, поддерживает пульс. Следите за ровным дыханием.", "Кардио", "Легкая", 2, "60 сек", 30, []string{"Ноги"}, []string{}, ""},
		{"Выпады назад", "Укрепление ног и баланса. Спина ровная, шаг контролируемый.", "Ноги", "Средняя", 3, "10-12", 45, []string{"Ноги"}, []string{}, ""},
		{"Растяжка задней поверхности бедра", "Мягкая растяжка сидя. Спина прямая, наклон от таза.", "Растяжка", "Легкая", 2, "20-30 сек", 20, []string{"Ноги"}, []string{"Коврик"}, ""},
		{"Подъемы на носки", "Укрепление голеней. Движение медленное, пятки контролируемые.", "Ноги", "Легкая", 3, "12-15", 30, []string{"Ноги"}, []string{}, ""},
		{"Боковая планка", "Удержание корпуса на боку для укрепления косых мышц. Не заваливайте таз.", "Кор", "Средняя", 3, "20-30 сек", 40, []string{"Пресс", "Боковые мышцы"}, []string{"Коврик"}, ""},
		{"Скручивания", "Классическое упражнение для пресса с контролем дыхания. Подбородок слегка прижат.", "Кор", "Легкая", 3, "12-15", 30, []string{"Пресс"}, []string{"Коврик"}, ""},
		{"Мертвый жук", "Стабилизация корпуса с попеременным движением рук и ног. Поясница прижата.", "Кор", "Легкая", 3, "10-12", 30, []string{"Пресс", "Кор"}, []string{"Коврик"}, ""},
		{"Тяга резинки к поясу", "Тяга эспандера к поясу для мышц спины. Лопатки сводите в конце.", "Спина", "Средняя", 3, "12-15", 40, []string{"Спина", "Лопатки"}, []string{"Резинка"}, ""},
		{"Сведение лопаток стоя", "Сведение лопаток для улучшения осанки. Не поднимайте плечи.", "Спина", "Легкая", 3, "12-15", 30, []string{"Лопатки", "Спина"}, []string{}, ""},
		{"Подъемы рук с гантелями", "Контролируемый подъем рук в стороны. Амплитуда до уровня плеч.", "Плечи", "Средняя", 3, "10-12", 40, []string{"Плечи"}, []string{"Гантели"}, ""},
		{"Растяжка плеч у стены", "Мягкая растяжка плечевого пояса у стены. Дышите ровно.", "Растяжка", "Легкая", 2, "20-30 сек", 20, []string{"Плечи"}, []string{"Стена"}, ""},
		{"Мобилизация грудного отдела на ролле", "Разгибание грудного отдела на массажном ролле. Не давите на поясницу.", "Мобилизация", "Легкая", 2, "8-10", 20, []string{"Грудной отдел", "Спина"}, []string{"Ролл"}, ""},
		{"Баланс на одной ноге", "Укрепление баланса и стабилизаторов. Фокус на устойчивости и ровной осанке.", "Мобилизация", "Легкая", 2, "30 сек", 20, []string{"Ноги", "Кор"}, []string{}, ""},
		{"Подъем коленей стоя", "Подъем коленей для мягкой кардио-нагрузки. Поддерживайте темп.", "Кардио", "Легкая", 3, "40 сек", 30, []string{"Ноги"}, []string{}, ""},
		{"Ягодичный мост с резинкой", "Мост с акцентом на ягодицы и стабилизацию. Сохраняйте нейтральную спину.", "Ноги", "Средняя", 3, "12-15", 40, []string{"Ягодицы", "Ноги"}, []string{"Резинка", "Коврик"}, ""},
		{"Шаги на платформу", "Подъемы на платформу для тонуса и кардио. Полная опора всей стопой.", "Кардио", "Средняя", 3, "40 сек", 40, []string{"Ноги"}, []string{"Степ-платформа"}, ""},
		{"Отведение ноги назад с резинкой", "Укрепление ягодиц с эспандером. Корпус устойчив.", "Ноги", "Средняя", 3, "12-15", 40, []string{"Ягодицы"}, []string{"Резинка"}, ""},
		{"Тяга гантели в наклоне", "Укрепление спины и широчайших. Спина ровная, локоть вдоль корпуса.", "Спина", "Средняя", 3, "10-12", 40, []string{"Спина"}, []string{"Гантель", "Стул"}, ""},
		{"Растяжка икр у стены", "Растяжка икроножных мышц с опорой. Пятка на полу.", "Растяжка", "Легкая", 2, "20-30 сек", 20, []string{"Икры"}, []string{"Стена"}, ""},
		{"Динамический шаг в сторону", "Легкая динамика для тазобедренных суставов. Движения плавные.", "Мобилизация", "Легкая", 2, "10-12", 20, []string{"Ноги", "Тазобедренные"}, []string{}, ""},
	}
...
func seedRewards(db *sql.DB) error {
	rewards := []struct {
		...
		{"Спортивная бутылка", "Полезный аксессуар для тренировок.", 80, "Мотивация"},
		{"Абонемент в бассейн", "1 месяц посещений бассейна.", 400, "Здоровье"},
		{"Йога-класс", "Групповое занятие для восстановления.", 220, "Здоровье"},
		{"Персональная консультация", "30 минут консультации со спортивным реабилитологом.", 500, "Премирование"},
	}
